...
void axpy_gpu_st(int N, float ALPHA, float * X, int INCX, float * Y, int INCY);
void axpy_gpu_offset_st(int N, float ALPHA, float * X, int OFFX, int INCX, float * Y, int OFFY, int INCY);
///////////////////////////
