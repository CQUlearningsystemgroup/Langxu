...
//printf("b\n\n");
        ...
        //float * test1;
        //test1[0] = l.weights_gpu[2];
	//int fp = open("./",O_WRONLY|O_CREAT);
	//write(fp,(float *)test1,sizeof(test1));
        //printf(" %lf",l.weights_gpu[2]);

        if(l.n == 3200)
	{
	printf("xl");
	axpy_gpu_st(l.nweights, learning_rate/batch, l.weight_updates_gpu, 1, l.weights_gpu, 1);
	}
